...
export default function Sidebar({
  ...
  // Close sidebar when a tag is selected on mobile
  const handleTagChange = (tag: TagType | "all" | "pinned") => {
    onTagChange(tag);
      ...
      {isMobile && (
        <button
          ...
          style={{
            ...
            boxShadow: "0 4px 16px rgba(90,72,225,0.35)",
        ...
        <div style={{ padding: "16px 20px", flex: 1 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            <FilterChip
              ...
              onClick={() => handleTagChange("pinned")}
              dot="#fbbf24"
            />
